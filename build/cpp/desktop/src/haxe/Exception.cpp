...
HX_DEFINE_STACK_FRAME(_hx_pos_38f034a961fd0425_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/home/rknopf/toolchains/haxe/current/std/cpp/_std/haxe/Exception.hx",5,0xab9a0cdd)
HX_LOCAL_STACK_FRAME(_hx_pos_38f034a961fd0425_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/home/rknopf/toolchains/haxe/current/std/cpp/_std/haxe/Exception.hx",76,0xab9a0cdd)
HX_LOCAL_STACK_FRAME(_hx_pos_38f034a961fd0425_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","/home/rknopf/toolchains/haxe/current/std/cpp/_std/haxe/Exception.hx",19,0xab9a0cdd)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_38f034a961fd0425_5_new)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_38f034a961fd0425_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_38f034a961fd0425_19_caught)
