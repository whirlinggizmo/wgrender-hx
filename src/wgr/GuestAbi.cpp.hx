...
// machine, and the glue to compile alongside. It rides on this class because the
// class is always in the build — the guest ABI is how the guest reaches the host.
