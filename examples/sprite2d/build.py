#!/usr/bin/env python3
"""Build `sprite2d` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='sprite2d', entry='Sprite2DDemo',
        title='sprite2d', background='#1c1c26').main()
