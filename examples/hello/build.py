#!/usr/bin/env python3
"""Build `hello` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='hello', entry='Hello',
        title='hello', background='#1c1c26').main()
