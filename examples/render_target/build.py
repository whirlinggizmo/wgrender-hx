#!/usr/bin/env python3
"""Build `render_target` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='render_target', entry='RenderTarget',
        title='render_target', background='#1c1c26').main()
