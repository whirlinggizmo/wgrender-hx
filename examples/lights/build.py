#!/usr/bin/env python3
"""Build `lights` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='lights', entry='LightsDemo',
        title='lights', background='#1c1c26').main()
