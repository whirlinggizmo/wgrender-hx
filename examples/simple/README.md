...
`src/wgr/impl/Raw.js.hx` is the other half — 51 calls hand-written for the ones that need
care, 46 generated by `tools/gen_raw_js.py` from `wgrender-hx's src/wgr/impl/Raw.cpp.hx` so the two
ports cannot drift.
