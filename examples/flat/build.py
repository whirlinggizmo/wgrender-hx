#!/usr/bin/env python3
"""Build `flat` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='flat', entry='FlatDemo',
        title='flat', background='#1c1c26').main()
