#!/usr/bin/env python3
"""Build `environment` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='environment', entry='EnvironmentDemo',
        title='environment', background='#1c1c26').main()
