#!/usr/bin/env python3
"""Build `2d` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='2d', entry='World2D',
        title='2d', background='#1c1c26').main()
