#!/usr/bin/env python3
"""Build `meshes` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='meshes', entry='MeshesDemo',
        title='meshes', background='#1c1c26').main()
