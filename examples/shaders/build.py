#!/usr/bin/env python3
"""Build `shaders` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='shaders', entry='Shaders',
        title='shaders', background='#1c1c26').main()
