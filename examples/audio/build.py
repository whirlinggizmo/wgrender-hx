#!/usr/bin/env python3
"""Build `audio` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='audio', entry='AudioDemo',
        title='audio', background='#1c1c26').main()
