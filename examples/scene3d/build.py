#!/usr/bin/env python3
"""Build `scene3d` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='scene3d', entry='Scene3D',
        title='scene3d', background='#1c1c26').main()
