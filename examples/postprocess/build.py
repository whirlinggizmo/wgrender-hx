#!/usr/bin/env python3
"""Build `postprocess` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='postprocess', entry='Postprocess',
        title='postprocess', background='#1c1c26').main()
