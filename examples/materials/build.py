#!/usr/bin/env python3
"""Build `materials` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='materials', entry='MaterialsDemo',
        title='materials', background='#1c1c26').main()
