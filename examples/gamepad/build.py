#!/usr/bin/env python3
"""Build `gamepad` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='gamepad', entry='Gamepad',
        title='gamepad', background='#1c1c26').main()
