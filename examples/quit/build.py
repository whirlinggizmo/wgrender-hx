#!/usr/bin/env python3
"""Build `quit` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='quit', entry='Quit',
        title='quit', background='#1c1c26').main()
