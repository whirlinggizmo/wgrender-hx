#!/usr/bin/env python3
"""Build `force_fetch` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='force_fetch', entry='ForceFetch',
        title='force_fetch', background='#1c1c26').main()
