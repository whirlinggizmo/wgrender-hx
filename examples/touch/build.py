#!/usr/bin/env python3
"""Build `touch` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='touch', entry='TouchDemo',
        title='touch', background='#1c1c26').main()
