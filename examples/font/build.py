#!/usr/bin/env python3
"""Build `font` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='font', entry='FontDemo',
        title='font', background='#1c1c26').main()
