#!/usr/bin/env python3
"""Build `instancing` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='instancing', entry='Instancing',
        title='instancing', background='#1c1c26').main()
