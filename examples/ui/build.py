#!/usr/bin/env python3
"""Build `ui` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='ui', entry='UiDemo',
        title='ui', background='#1c1c26').main()
