#!/usr/bin/env python3
"""Build `model` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='model', entry='ModelDemo',
        title='model', background='#1c1c26').main()
