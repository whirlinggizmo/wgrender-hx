#!/usr/bin/env python3
"""Build `textures` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='textures', entry='TexturesDemo',
        title='textures', background='#1c1c26').main()
