#!/usr/bin/env python3
"""Build `particles` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='particles', entry='Particles',
        title='particles', background='#0b0b10').main()
