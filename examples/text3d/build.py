#!/usr/bin/env python3
"""Build `text3d` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='text3d', entry='Text3DDemo',
        title='text3d', background='#1c1c26').main()
