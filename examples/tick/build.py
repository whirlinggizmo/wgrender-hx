#!/usr/bin/env python3
"""Build `tick` as a wgrender host with a Haxe guest on top.
...
Project(root=pathlib.Path(__file__).resolve().parent, name='tick', entry='Tick',
        title='tick', background='#1c1c26').main()
